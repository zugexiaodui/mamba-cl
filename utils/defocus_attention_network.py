...
class DefocusAttentionNetwork(nn.Module):
    ...
    def encode_image(self, x: Tensor, drop_path_rate=0.0, tblogger=None, pre_logits=True):
        assert pre_logits
        return self.forward_features(x, drop_path_rate, tblogger)
